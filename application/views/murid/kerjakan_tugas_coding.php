    ...
    .CodeMirror {
        ...
        font-size: 14px;
            ...
            #output-container {
                ...
                background-color: #FFFFFF; /* White background for normal appearance */
                ...
                border: 1px solid #dddddd; /* Lighter border for normal appearance */
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form id="form-coding" action="<?= site_url('murid/tugas/submit_coding'); ?>" method="POST">
                                                ...
                                                <div class="mt-3">
                                                    ...
                                                    <button type="button" id="run-btn" class="btn btn-info">
